...
AGENT_PROMPT = {
    ...
    "system": """
    You are a intelligence analyst specializing in global oil energy markets for Chevron. Your task is to analyse
    social media posts and extract insight, conside intelligence signals related to Iran conflict and Chevron's specific interests. 
    """,
    ...
    You have analysed {total} posts. Synthesize a final intelligence assessment brefing covering related to Chevron: 
    ...
    Give a final assessment overall what does this mean for Chevron and predict its implications for the next day or hours.
...
def run_agent_insight(input_path: str, output_path: str, api_key: str) -> None:
    ...
    combined_csv = os.path.join("CSV_Files", f"{base}_Chevron.csv")
...
# ── Save conclusion CSV ───────────────────────────────────────────────────
    ...
    conclusion_csv = os.path.join("Final_Assessment", f"{base}_conclusion_{timestamp}_Chevron.csv")
    conclusion_row = {
        "Timestamp":                   timestamp,
